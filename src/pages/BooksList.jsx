...
import { BookOpen, Search, Plus, Edit, Trash2, Eye, X, Book, Calendar, Layers, Hash } from 'lucide-react';
...
const BooksList = () => {
  ...
  const fetchBooks = async () => {
    ...
    try {
      ...
      // alert('Failed to load books. Please try again.'); // Removed alert for cleaner UX
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-slate-800 font-sans">
      {/* Navbar */}
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-30 bg-opacity-90 backdrop-blur-md">
          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium tracking-wide">LIBRARY MANAGER</p>
              </div>
            </div>
            <Link
              to="/books/create"
              className="group flex items-center gap-2 bg-blue-600 text-white px-5 py-2.5 rounded-full hover:bg-blue-700 active:bg-blue-800 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-0.5"
            >
